...
Show that:
\[Var(aX + bY + c) = a^2 Var(X) + b^2 Var(Y) + c.\]
		...
		\begin{solution}
			The First Order Condition is:
				...
				So we have
					$$\omega^* = \frac{\sigma_2^2 - \rho\sigma_1\sigma_2}{\sigma_1^2 + \sigma_2^2 -2\rho\sigma_1\sigma_2}$$
		\end{solution}
    \part I have posted five years of daily closing stock prices for Apple (AAPL) and Google (GOOG) on my website: \texttt{http://ditraglia.com/econ103/closing\_prices.csv}.
