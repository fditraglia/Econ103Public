...
\begin{verbatim}
##            [,1]       [,2]       [,3]       [,4]       [,5]
## [1,] -0.9995123 -0.4517845 -0.9220031 -0.9165308 -0.5996661
## [2,]  0.2400777  0.7878056  0.3175870  0.3230593  0.6399239
\end{verbatim}
\begin{alltt}
...
\begin{verbatim}
##             [,1]       [,2]       [,3]       [,4]         [,5]
## [1,] -0.02442314 -0.1846505 -0.0822607 -0.4258605 -0.624551457
## [2,]  0.59537189  0.4351445  0.5375343  0.1939345 -0.004756424
\end{verbatim}
\begin{alltt}
\hlstd{lower} \hlkwb{<-} \hlstd{simCIs[}\hlnum{1}\hlstd{,]}
\hlstd{upper} \hlkwb{<-} \hlstd{simCIs[}\hlnum{2}\hlstd{,]}
