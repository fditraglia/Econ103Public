...
```{r exercise_1, echo = FALSE, results = 'hide'}
...
```{r exercise_2, echo = FALSE, results = 'hide'}
...
```{r exercise_3, echo = FALSE, results = 'hide'}
...
Write an *even more general* version of the function `two.dice` called `my.dice.sum` that takes two arguments: `n.sides` tells how many sides each die has and `n.dice` tells how many dice we roll. For example if `n.sides = 4` and `n.dice = 3`, we're rolling three four-sided dice, i.e., dice with sides numbered 1-4. Use `repilcate` to simulate the sum of five four-sided dice a total of 100 times.

```{r exercise_4, echo = FALSE, results = 'hide'}
...
```{r exercise_5, echo = FALSE, results = 'hide'}
sum(z == 3)/length(z)
sum(z < 7)/length(z)
```
...
```{r exercise_6, echo = FALSE, results = 'hide'}
...
```{r exercise_7, echo = FALSE, results = 'hide'}
...
```{r exercise_8, echo = FALSE, results = 'hide'}
