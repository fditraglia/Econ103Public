...
```{r exercise_4, echo = FALSE, results = 'hide', fig.show = 'hide'}
...
```{r exercise_6, echo = FALSE, results = 'hide', fig.show = 'hide'}
support <- 0:20
...
```{r exercise_8, echo = FALSE, results = 'hide', fig.show = 'hide'}
...
```{r exercise_9, results = 'hide', echo = FALSE, fig.show = 'hide'}
#Part 1
...
```{r exercise_10, echo = FALSE, results = 'hide', fig.show = 'hide'}
...
```{r exercise_11, echo = FALSE, results = 'hide', fig.show = 'hide'}
#Exercise 11-1
n <- 10000
