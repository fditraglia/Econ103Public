...
\begin{block}
	{Experiment}
	\begin{itemize}
		\item Weight a known 10 gram mass 16 times on the same scale.
...
\begin{block}{Two Kinds of Scales}
	\begin{description}
			\item[Biased] Correct on average: $\mu = 10$ grams
			\item[Unbiased] \emph{Too high} on average: $\mu = 11$ grams
		\end{description}	
...
\vspace{2em}
	...
	\alert{\fbox{\Large The \emph{power} of this test is 50\%}}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\begin{frame}
	...
	\begin{eqnarray*}
		T_n &=& \frac{\bar{X}_n}{\sigma/\sqrt{n}}\\\\
		&=& \frac{\bar{X}_n}{\sigma/\sqrt{n}} \alert{- \frac{\mu}{\sigma/\sqrt{n}} + \frac{\mu}{\sigma/\sqrt{n}}} \\ \\
		&=& \left( \frac{\bar{X}_n - \mu}{\sigma/\sqrt{n}} \right) + \frac{\mu}{\sigma/\sqrt{n}}
	\end{eqnarray*}
\end{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{Defense Against the Dark Arts: Hypothesis Testing Edition}
	\begin{enumerate}
		\item Statistical Significance $\neq$ Practical Importance 
			\begin{itemize}
				\item Is the null even interesting?
				\item How to report Results: CIs versus tests
			\end{itemize}
		\item ``The difference between significant and insignificant it not itself significant.'' 
		\item Data Dredging / Multiple Hypothesis Testing
		\item There is no good decision-theoretic justification for hypothesis testing 
	\end{enumerate}
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
