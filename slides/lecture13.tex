...
\begin{alltt}
\hlstd{survey} \hlkwb{<-} \hlkwd{read.csv}\hlstd{(}\hlstr{'http://ditraglia.com/econ103/old_survey.csv'}\hlstd{)}
\hlstd{height} \hlkwb{<-} \hlkwd{na.omit}\hlstd{(survey}\hlopt{$}\hlstd{height)}
\hlkwd{hist}\hlstd{(height,} \hlkwc{freq} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{xlab} \hlstd{=} \hlstr{''}\hlstd{,}
     \hlkwc{main} \hlstd{=} \hlstr{'Population Dist. of Height (inches)'}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/pop_hist-1} 
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{# What is the population mean?}
...
\end{verbatim}
\begin{alltt}
\hlcom{# Draw a random sample of n = 5 and compute the sample mean}
\hlkwd{set.seed}\hlstd{(}\hlnum{3827}\hlstd{)}
\hlstd{random_sample} \hlkwb{<-} \hlkwd{sample}\hlstd{(height,} \hlnum{5}\hlstd{,} \hlkwc{replace} \hlstd{=} \hlnum{TRUE}\hlstd{)}
\hlstd{random_sample}
\end{alltt}
\begin{verbatim}
## [1] 65 75 69 67 69
\end{verbatim}
\begin{alltt}
\hlkwd{mean}\hlstd{(random_sample)}
\end{alltt}
\begin{verbatim}
## [1] 69
\end{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlkwd{set.seed}\hlstd{(}\hlnum{2985}\hlstd{)}
\hlcom{# Function: take a random sample of size n, compute sample mean}
\hlstd{draw_xbar} \hlkwb{<-} \hlkwa{function}\hlstd{(}\hlkwc{n}\hlstd{) \{}
  \hlstd{random_sample} \hlkwb{<-} \hlkwd{sample}\hlstd{(height,} \hlkwc{size} \hlstd{= n,} \hlkwc{replace} \hlstd{=} \hlnum{TRUE}\hlstd{)}
  \hlkwd{mean}\hlstd{(random_sample)}
\hlstd{\}}
\hlcom{# Calculate the mean of 10000 random samples with n = 5}
\hlstd{M} \hlkwb{<-} \hlnum{10000}
\hlstd{xbar_5} \hlkwb{<-} \hlkwd{replicate}\hlstd{(M,} \hlkwd{draw_xbar}\hlstd{(}\hlnum{5}\hlstd{))}
\hlcom{# Compare simulated sample means to population mean: 67.5454 in.}
\hlkwd{head}\hlstd{(xbar_5)}
\end{alltt}
\begin{verbatim}
...
\definecolor{shadecolor}{rgb}{0.969, 0.969, 0.969}\color{fgcolor}\begin{kframe}
\begin{alltt}
\hlcom{# Compare popn. dist. of height to histogram of the simulated x-bars}
\hlkwd{par}\hlstd{(}\hlkwc{mfrow} \hlstd{=} \hlkwd{c}\hlstd{(}\hlnum{1}\hlstd{,}\hlnum{2}\hlstd{))}
\hlkwd{hist}\hlstd{(height,} \hlkwc{freq} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{main} \hlstd{=} \hlstr{'Population'}\hlstd{)}
\hlkwd{hist}\hlstd{(xbar_5,} \hlkwc{freq} \hlstd{=} \hlnum{FALSE}\hlstd{,} \hlkwc{main} \hlstd{=} \hlstr{'Sampling Dist. of Xbar (n = 5)'}\hlstd{)}
\end{alltt}
\end{kframe}
\includegraphics[width=\maxwidth]{figure/pop_vs_sampling5_hist-1} 
...
\end{verbatim}
\begin{alltt}
\hlcom{# Mean of sampling dist. of x-bar (n = 5)}
\hlkwd{mean}\hlstd{(xbar_5)}
\end{alltt}
\begin{verbatim}
## [1] 67.55678
\end{verbatim}
\begin{alltt}
\hlcom{# Population variance}
\hlkwd{var}\hlstd{(height)}
\end{alltt}
\begin{verbatim}
## [1] 19.74504
\end{verbatim}
\begin{alltt}
\hlcom{# Variance of sampling dist of x-bar (n = 5)}
\hlkwd{var}\hlstd{(xbar_5)}
\end{alltt}
\begin{verbatim}
## [1] 3.780202
\end{verbatim}
