...
and this is called the \alert{Law of Iterated Expectations}.
I've posted a proof \textcolor{blue}{\href{http://ditraglia.com/Econ103Public/OptionalProofs.pdf}{\fbox{HERE}}} for those who are interested.
...
As explained above, if $X$ and $Y$ are independent, $Cov(X,Y)=0$. Hence, independence implies
\begin{eqnarray*}
