...
\begin{frame}
	...
	Just need to put in the calculations...
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
	\frametitle{More Efficient Estimator?}
	Unlike the one-sample example we don't known the SE under the null. If the null is true, however, there is a better estimator of the standard error based on pooling the data.
\end{frame}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\begin{frame}
