...
Any readings that do not come from the text will be downloadable from on Piazza.
...
Be sure to use these responsibly: you gain nothing by simply reading through the answers.



\section*{Assignments and Grading}

Grades for this course will be determined based on ten in-class quizzes, two in-class midterms, and a comprehensive final examination:
	\begin{equation*}
	\begin{split}
...
\options{4/26/2018}{\noclassday} % finals
\caltext{4/26/2018}{\textbf{Reading Day -- No Class}}
\end{calendar}
\end{center}
