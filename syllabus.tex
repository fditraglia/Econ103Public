...
\medskip
	% \begin{quote}
	% 	\begin{tabular}{llll}
	% 	 A+\phantom{-} = \phantom{-}98-100& B+\phantom{-} = \phantom{-}87-89 &C+\phantom{-} = \phantom{-}77-79 & D+\phantom{-} = \phantom{-}67-69\\
	% 	 A\phantom{+-} = \phantom{-}93--97& B\phantom{+-}  = \phantom{-}83-86 & C\phantom{+-}  =\phantom{-} 73-76 &  D\phantom{+-}  = \phantom{-}60-66\\
	% 	 A-\phantom{+} = \phantom{-}90--92& B-\phantom{+} =  \phantom{-}80-82 & C-\phantom{+} = \phantom{-}70-72 &
	% 	\end{tabular}
	% \end{quote}  
 % \smallskip
...
\noindent \textbf{Quizzes:} Your RIs will administer \total{quizcounter} short quizzes in recitation over the course of the semester. (See the semester calendar below.) Each quiz will cover basic material from the most recent lectures since the last quiz or midterm. When calculating your quiz average, I will drop your two lowest scores and weight the remaining quizzes evenly. No makeup quizzes will be given so use your two ``free skips'' carefully. Quizzes will not be returned and answers will not be posted.
