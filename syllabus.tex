...
Audio and screen captures of the lectures for this course recorded and posted on \href{http://upenn.instructure.com}{Canvas}. 
...
If you encounter any problems with the recordings, please contact \url{mms-help@sas.upenn.edu} directly.
\medskip
...
I will post homework and solutions on the course website throughout the semester. 
...
Grades for this course will be determined based on quizzes, two midterms, a final examination:
The grading scheme is as follows:
	...
	\end{split}
	\end{equation*}
You can earn extra credit worth up to 5\% for active participation, both in-class and online: see ``Extra Credit.'' 
